...
@Controller public class LogoutHandler extends SecurityContextLogoutHandler {
	 ...
	 */
	@Autowired public LogoutHandler(ClientRegistrationRepository
		clientRegistrationRepository) {
	 ...
	 */
	@Override public void logout(HttpServletRequest httpServletRequest,
		...
		String issuer =
			(String)getClientRegistration().getProviderDetails().
